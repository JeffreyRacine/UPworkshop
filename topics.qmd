...
- Day 2
  ...
  - AM Introduction to nonparametric kernel regression, estimation, inference, interpretation
  - PM Hands on lab, R and exercises
...
- Day 4
  ...
  - AM Introduction to semiparametric kernel methods
  - PM Hands on lab, R and exercises
  
- Day 5

  - AM Introduction to assessing parametric vs. semiparametric vs. nonparametric models, new tools for reproducible research
